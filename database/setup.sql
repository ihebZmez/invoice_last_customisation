...
CREATE TABLE `user_accounts` (
  ...
  `user_id6` int(10) unsigned DEFAULT NULL,
  `user_id7` int(10) unsigned DEFAULT NULL,
  `user_id8` int(10) unsigned DEFAULT NULL,
  `user_id9` int(10) unsigned DEFAULT NULL,
  `user_id10` int(10) unsigned DEFAULT NULL,
  `user_id11` int(10) unsigned DEFAULT NULL,
  `user_id12` int(10) unsigned DEFAULT NULL,
  `user_id13` int(10) unsigned DEFAULT NULL,
  `user_id14` int(10) unsigned DEFAULT NULL,
  `user_id15` int(10) unsigned DEFAULT NULL,
  `user_id16` int(10) unsigned DEFAULT NULL,
  `user_id17` int(10) unsigned DEFAULT NULL,
  `user_id18` int(10) unsigned DEFAULT NULL,
  `user_id19` int(10) unsigned DEFAULT NULL,
  `user_id20` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `user_accounts_user_id6_index` (`user_id6`),
  KEY `user_accounts_user_id7_index` (`user_id7`),
  KEY `user_accounts_user_id8_index` (`user_id8`),
  KEY `user_accounts_user_id9_index` (`user_id9`),
  KEY `user_accounts_user_id10_index` (`user_id10`),
  KEY `user_accounts_user_id11_index` (`user_id11`),
  KEY `user_accounts_user_id12_index` (`user_id12`),
  KEY `user_accounts_user_id13_index` (`user_id13`),
  KEY `user_accounts_user_id14_index` (`user_id14`),
  KEY `user_accounts_user_id15_index` (`user_id15`),
  KEY `user_accounts_user_id16_index` (`user_id16`),
  KEY `user_accounts_user_id17_index` (`user_id17`),
  KEY `user_accounts_user_id18_index` (`user_id18`),
  KEY `user_accounts_user_id19_index` (`user_id19`),
  KEY `user_accounts_user_id20_index` (`user_id20`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
